...
public class JobPortalJobsController {
    ...
    public String centralJobs(Model model, Pageable pageable) {
        Page<JobSummary> jobNotificationPage = jobNotificationRepository.findByJobType_Type("Central Government Job", pageable);
    ...
    public String stateJobs(Model model, Pageable pageable) {
        Page<JobSummary> jobNotificationPage = jobNotificationRepository.findByJobType_Type("State Government Job", pageable);
    ...
    public String otherStateJobs(Model model, Pageable pageable) {
        Page<JobSummary> jobNotificationPage = jobNotificationRepository.findByJobType_Type("Other", pageable);
