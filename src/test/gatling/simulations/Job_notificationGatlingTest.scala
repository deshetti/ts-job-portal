...
/**
 * Performance test for the Job_notification entity.
 */
class Job_notificationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Job_notification entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all job_notifications")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created job_notification")
                .get("${new_job_notification_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created job_notification")
            .delete("${new_job_notification_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
